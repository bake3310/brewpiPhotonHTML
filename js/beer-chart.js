...
var lineNames = {
    ...
    log1Temp: 'Beer2 temperature',
    log2Temp: 'Room temperature',
    log3Temp: 'Log3 temperature',
};
var chartColors = [ 
    'rgb(41,170,41)', // green for beer temp
    'rgb(240, 100, 100)', // red for beer setting
    'rgb(89, 184, 255)', // blue for fridge temp 
    'rgb(255, 161, 76)', // orange for fridge setting
    'rgb(170,41,255)', // purple for berr2 temp
    'rgb(96,96,96)', // grey for room temperature
    '#AAAAAA',
    'rgb(153,0,153)',
];
